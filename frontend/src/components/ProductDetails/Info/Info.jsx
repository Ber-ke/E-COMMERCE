            ...
            <form className="variations-form">
                <div className="variations">
                        ...
                        <div className="colors-wrapper">
                            {singleProduct.color.map((color, index) => (
                                <div className="color-wrapper" key={index}>
                                    <label className="green-color" style={{backgroundColor: `#${color}`}}>
                    ...
                    <div className="cart-button">
                        ...
                        <button className="btn btn-lg btn-primary" id="add-to-cart"
                                type="button" disabled={filteredCard} onClick={() => addToCart({
                            ...singleProduct,
